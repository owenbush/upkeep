...
# it is the slow, heavy half that makes container CI flaky and then ignored.
#
...
#
# Usage:  internal/contract/fixture/setup.sh <dir>
# Then:   UPKEEP_DDEV_PROJECT=<dir> go test ./internal/contract/ -v
set -euo pipefail
...
echo "  UPKEEP_DDEV_PROJECT=$(pwd) go test ./internal/contract/ -v"
