...
final class CheckResultTest extends TestCase
{
    ...
    public function testPhpUnitWithNoDiscoveredTestsIsRecordedAsNoTestsNotAFailure(): void
    {
        ...
        $zeroExit = CheckResult::fromProcess(CheckType::PhpUnit, 0, "PHPUnit 11.5.56 by Sebastian Bergmann and contributors.\n\nRuntime:       PHP 8.4.18\n\nNo tests executed!\n", 2.0);
    ...
    {
        $result = CheckResult::fromProcess(CheckType::PhpUnit, 1, "FAILURES!\nTests: 5, Assertions: 9, Failures: 1.\n", 3.0);
        self::assertSame(CheckStatus::Failed, $result->status);
    }
    ...
    {
        $result = CheckResult::unavailable(CheckType::Deprecation, 'The engine provides no deprecation command for Drupal 11.');
