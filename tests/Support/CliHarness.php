...
final class CliHarness
{
    ...
    public function application(): Application
    {
        ...
        $application->addCommands([
            ...
            new PatchApplyCommand($engines, $this->drupalOrg, $this->patchDownloader, $this->gitlab),
            new PatchCheckCommand($engines, $this->drupalOrg, $this->patchDownloader, $this->gitlab),
            new PatchPromoteCommand($engines, $this->drupalOrg, $this->patchDownloader, $this->gitlab),
